...
資料庫系統: 期末專題:圖書管理系統 React + Python Flask + SQLite<br>
分散式系統: 期末專題: Kafka 電商搶購平台<br>
課程包含分散式系統的基本模型、網路軟體設計基礎知識、同步(Remoting)與非同步通訊模式(Group/Message-based/Shared Memory)<br>
Naming、Coordination、分散式交易、Web 服務、微服務<br>
作業系統: 作業包含如何開發和調試 LKM、利用 eBPF 進行高效的系統監控和性能分析，並掌握了容器化技術(Namespace、Cgroup)的應用<br>
數位系統系統實驗:實作加法器、減法器、乘法器、數值比較器、編碼器、解碼器及七段顯示器電路<br>

人工智慧課程相關<br>
數學軟體應用: 期末專題:利用 LSTM 預測台積電股價<br>
課程內容包含人工智慧和深度學習的原理與應用，涵蓋全連結、CNN、RNN、Transformers、GAN 和強化學習技術。
使用 Python 和 TensorFlow 框架，配合 Gradio、Transformers 和 FaceNet 等套件進行實作
人工智慧的商業應用: 期末專題:使用多模型預測台灣銀行破產機率<br>
課程內容機器學習的回歸、分類和聚類方法，深度學習中的 CNN 和 RNN，以及強化學習。此外，課程還涵蓋了 AI 在金融科技中的應用。<br>
人工智慧與語音處理實務:期末專題:文字語音合成與風格轉換 Tacotron-based model<br>
課程內容涵蓋了語音資料的基本理論、語音處理、語音辨識、語音合成和自然語言。<br>
